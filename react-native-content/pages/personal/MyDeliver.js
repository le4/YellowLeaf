    ...
    render() {
        return (
            <View style={{backgroundColor: "#fff", flex: 1}}>
                <TitleView title="已投递" {...this.props} showShare={true}/>
                <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
                    <View style={{backgroundColor: "#fff"}}>
                        <Text style={styles.title} numberOfLines={1}>托管班带班老师</Text>
                        <View
                            style={{
                                marginLeft: 36 * k,
                                marginTop: 20 * k,
                    ...
                    <View style={styles.container}>
                        ...
                        >
                            <TabPane tab="职位描述" key="1" style={{backgroundColor: "#fff"}}>
                                <View style={{
                                    alignItems: 'center',
                ...
                <View
                    ...
                    <View style={{
                        ...
                        <Text style={{color: "#fff", fontSize: 32 * k, marginLeft: 13 * k}}>已投递</Text>
                    </View>
                    <View style={{
                        width: 300 * k,
                        height: 95 * k,
                        ...
                        <Text style={{color: "#fff", fontSize: 32 * k, marginLeft: 10 * k}}>收藏</Text>
                    </View>
                </View>
            </View>
        );
